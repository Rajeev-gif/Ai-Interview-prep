        ...
        <div className="flex items-start justify-between cursor-pointer">
          ...
          <div className="flex items-center justify-end ml-4 relative">
            ...
            >
              ...
              <button
                className="flex items-center gap-2 text-xs text-cyan-800 font-medium bg-cyan-50 px-5 py-1 mr-2 rounded text-nowrap border border-cyan-50 hover:border-cyan-200 cursor-pointer"
                onClick={() => {
                  setIsExpanded(true);
                  onLearnMore();
                }}
