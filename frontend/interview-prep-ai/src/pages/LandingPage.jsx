        ...
        <div className="container mx-auto px-4 pt-6 pb-[200px] relative z-10">
          ...
          <div className="flex flex-col md:flex-row itmes-center">
            <div className="w-full md:w-1/2 pr-4 mb-8 md:mb-0">
              <div className="flex itmes-center justify-left mb-2">
            ...
            <div className="w-full md:w-1/2">
              <p className="text-[17px] text-gray-900 mr-0 md:mr-20 mb-6">
                Get a role-specefic questions, expand answers when you need
                them, div deeper into concepts, and organize everything your
                way. From preparation to master - your ultimate Interview
                toolkit ia here.
              </p>
