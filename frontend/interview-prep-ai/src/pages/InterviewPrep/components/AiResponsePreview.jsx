  ...
  return (
    <div className="relative my-6 rounded-lg overflow-hidden bg-gray-50 border border-gray-200">
      <div className="flex items-center justify-between px-4 py-2 bg-gray-100 border-b border-gray-200">
        ...
        >
          {copied ? (
            <LuCheck size={16} className="text-green-600 mr-16" />
          ) : (
            <LuCopy size={16} />
          )}
          {copied && (
            <span className="absolute -top-1 right-0 bg-gray-800 text-white text-xs rounded-md px-2 py-1 opacity-80 group-hover:opacity-100 transition">
              Copied!
            </span>
          )}
        </button>
